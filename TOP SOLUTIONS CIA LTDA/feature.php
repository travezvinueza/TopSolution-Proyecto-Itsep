  ...
  <section class="feature_section layout_padding2 layout_margin">
    <div class="container">
      <div class="heading_container">
        <h2>
          Características asombrosas para usar <br />
        ...
        <div class="col-md-4">
          <div class="box">
            ...
            <div class="detail-box">
              <p>
                Estamos enfocados en desarrollar constantes mejoras en los productos y servicios que brindamos, con el objetivo de mejorar la eficiencia de desarrollo, la productividad y la diferenciación competitiva de un producto existente.
              </p>
            </div>
          </div>
        </div>
