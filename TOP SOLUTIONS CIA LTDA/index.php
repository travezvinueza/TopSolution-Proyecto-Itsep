...
<body>
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="detail-box">
              <h3>
              ESTRATEGIAS PARA UN MUNDO DIGITAL
              </h3>
              <h1>
                TOP <br />
                SOLUTIONS CIA LTDA
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box">
            ...
            <div class="detail-box">
              <p>
                Análisis del negocio orientado a la implementación de soluciones móviles multiplataforma.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="box">
            <div class="head-box">
              ...
              <h6>
                Diseño Aplicaciones Mobiles
              </h6>
            </div>
            <div class="detail-box">
              <p>
                Soluciones de software buscando un enfoque de innovación.
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="download_section layout_padding-bottom">
    <div class="container">
      <div class="heading_container">
        <h2>
          Aplicacion en todo y en cualquier lugar
        </h2>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="box">
              ...
              <div class="detail-box">
                <p>
                  Respaldado por un increíble equipo de soporte
                  Mantenemos un conexión permanente con nuestros clientes
                </p>
              </div>
            </div>
            <div class="box">
              ...
              <div class="detail-box">
                <p>
                  Todas nuestras soluciones han sido diseñadas intencionalmente para incluir las funciones que deseas, justo donde las necesitas, sin ser demasiadas complicadas.
                </p>
              </div>
            </div>
            <div>
          ...
          <div class="col-md-4">
            <div class="box">
              <div class="head-box">
                ...
                <h6>
                  PLATAFORMAS WEBS Y APPS
                </h6>
              </div>
              <div class="detail-box">
                <p>
                  Accesibles en todos tus dispositivos
Nuestras soluciones son aplicaciones webs y cuentan con su respectiva aplicación móvil*
                </p>
              </div>
            </div>
            <div class="box">
              ...
              <div class="detail-box">
                <p>
                  Todo lo que hace nuestra compañía es la búsqueda constante de la excelencia y un compromiso inquebrantable para desarrollar los mejores productos y servicios en el mercado
                </p>
              </div>
            </div>
            <div>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="detail-box b-1">
              <p>
                Nos comprometemos a convertirnos en una empresa de colaboraciones bipartita, para así crecer de la mano de nuestros clientes
              </p>
              <a href="">
                Leer mas
              </a>
          ...
          <div class="col-md-5">
            <div class="detail-box b-2">
              <p>
                Trabajar de manera ética es la base de nuestro negocio. Todo lo que hacemos está guiado por una brújula moral que garantiza la equidad, el respeto a todos los interesados y la transparencia total
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="client_container layout_padding2-top">
        ...
        <div class="client-detail">
          <p>
            Ser una empresa líder en desarrollo de tecnologías de última generación a nivel nacional adaptándonos a las cambiantes condiciones de mercado y a las demandas y necesidades de nuestros clientes.
          </p>
        </div>
    ...
    <div class="container">
      <div class="social_container">
        ...
        <div class="social-box">
          ...
          <a href="https://github.com/travezvinueza">
